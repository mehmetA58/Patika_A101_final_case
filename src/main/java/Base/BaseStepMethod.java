...
public class BaseStepMethod {
   ...
   private String titleCSV;
    ...
    protected void csvWriter(By locator) throws IOException {
        String csv = "C:\\Users\\PC\\IdeaProjects\\Patika_A101_FinalCase\\productsTitle.csv";
    ...
    public String csvReader() throws IOException, CsvException {
        CSVReader reader = new CSVReader(new FileReader("C:\\Users\\PC\\IdeaProjects\\Patika_A101_FinalCase\\productsTitle.csv"));
        String[] csvCell;
